...
import { BuyingRealEstateService } from './BuyingRealEstate.service';
import 'rxjs/add/operator/toPromise';

@Component({
  selector: 'app-buyingrealestate',
  templateUrl: './BuyingRealEstate.component.html',
  styleUrls: ['./BuyingRealEstate.component.css'],
  providers: [BuyingRealEstateService]
})
export class BuyingRealEstateComponent implements OnInit {
  ...
  constructor(private serviceBuyingRealEstate: BuyingRealEstateService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceBuyingRealEstate.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceBuyingRealEstate.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceBuyingRealEstate.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceBuyingRealEstate.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceBuyingRealEstate.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
