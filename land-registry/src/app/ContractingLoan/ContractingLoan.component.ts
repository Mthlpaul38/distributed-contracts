...
import { ContractingLoanService } from './ContractingLoan.service';
import 'rxjs/add/operator/toPromise';

@Component({
  selector: 'app-contractingloan',
  templateUrl: './ContractingLoan.component.html',
  styleUrls: ['./ContractingLoan.component.css'],
  providers: [ContractingLoanService]
})
export class ContractingLoanComponent implements OnInit {
  ...
  constructor(private serviceContractingLoan: ContractingLoanService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceContractingLoan.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceContractingLoan.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceContractingLoan.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceContractingLoan.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceContractingLoan.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
